from lang_helper_by_delica.SpanishVerbRegER import SpanishVerbRegER
from lang_constants import *

class SpanishIrregularERVerb(SpanishVerbRegER):
    def __init__(self, verb, english_def="", verb_type=SPANISH_IRREGULAR_ER_VERB_TYPE,
